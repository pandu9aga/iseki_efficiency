...
<head>
    ...
    <title>Mulai Perbantuan - Iseki Efficiency</title>
...
<body>
    <div class="card">
        <h2 class="title">🤝 Mulai Perbantuan</h2>
        ...
        <form method="POST" action="{{ route('assistances.storeStart') }}" id="startForm">
            @csrf
            <div class="form-group">
                <label>Scan / Ketik NIK Perbantuan</label>
            ...
            <div class="form-group">
                <label>Pilih PIC yang Dibantu (Hari Ini)</label>
    ...
    <script>
        ...
        function verifyNik(nik) {
            $.ajax({
                url: "{{ route('assistances.verifyNik') }}",
                type: "POST",
