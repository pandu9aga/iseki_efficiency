...
class MonitorController extends Controller
{
    ...
    public function replacements(Request $request)
    {
        ...
        return view('admins.monitoring.replacements', compact('replacements', 'filterType', 'filterDate', 'filterMonth', 'durationSummary'));
    }
    ...
    public function assistances(Request $request)
    {
        ...
        return view('admins.monitoring.assistances', compact('assistances', 'filterType', 'filterDate', 'filterMonth', 'durationSummary'));
    }
}
