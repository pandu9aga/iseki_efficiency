                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('leaders.reports.cost.destroy', $cost) }}" method="POST" class="d-inline">
                                            @csrf @method('DELETE')
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('leaders.reports.power.destroy', $power) }}" method="POST" class="d-inline">
                                            @csrf @method('DELETE')
                                            <button type="submit" class="btn btn-sm btn-danger"
    ...
    <section class="section">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addPenangananModal">
                    Add
                </button>
            </div>
            <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('leaders.reports.penanganan.destroy', $p) }}" method="POST" class="d-inline">
                                            @csrf @method('DELETE')
                                            <button type="submit" class="btn btn-sm btn-danger"
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select name="Id_Member" class="form-control tom-select" required>
                            ...
                            @foreach(\App\Models\Member::orderBy('nama')->get() as $m)
                            <option value="{{ $m->id }}" {{ isset($power) && $m->id == $power->Id_Member ? 'selected' : '' }}>
                                {{ $m->nama }}
                            </option>
                            @endforeach
                        </select>
        ...
        <form action="{{ route('leaders.reports.power.update', $power) }}" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @php
                        $costTime = \Carbon\Carbon::parse($power->Start_Power)->format('H:i');
                    @endphp
        ...
        <form action="{{ route('leaders.reports.penanganan.store') }}" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label>Description</label>
                        <textarea name="Keterangan_Penanganan" class="form-control" required></textarea>
                    </div>
                    <div class="mb-3">
                        <label>Start</label>
                        <input type="date" name="date_part" class="form-control" value="{{ $dateString }}" readonly>
        ...
        <form action="{{ route('leaders.reports.penanganan.update', $p) }}" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label>Description</label>
                        <textarea name="Keterangan_Penanganan" class="form-control" required>{{ $p->Keterangan_Penanganan }}</textarea>
                    </div>
                    @php
                        $costTime = \Carbon\Carbon::parse($p->Start_Penanganan)->format('H:i');
                    @endphp
...
document.addEventListener('DOMContentLoaded', function() {
    // Inisialisasi semua select dengan class `tom-select`
    const selects = document.querySelectorAll('.tom-select');
    selects.forEach(select => {
        new TomSelect(select, {
            placeholder: '-- Select Member --',
            allowEmptyOption: true,
            plugins: ['dropdown_input'] // aktifkan pencarian
        });
    });
});
