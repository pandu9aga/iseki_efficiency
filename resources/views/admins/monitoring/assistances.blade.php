    ...
    <section class="section">
        <div class="card">
            <div class="card-header pb-0">
                <form method="GET" action="{{ route('admins.monitoring.assistances') }}" id="filterForm">
                        ...
                        <table class="table table-sm table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-outline-success" type="button" data-bs-toggle="collapse" data-bs-target="#detailAssist{{ $idx }}">
                                            <i class="bi bi-eye"></i> Rincian
                                        </button>
                                    </td>
                                </tr>
                                <tr class="collapse" id="detailAssist{{ $idx }}">
