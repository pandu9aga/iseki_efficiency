                        ...
                        <table class="table table-sm table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-outline-primary" type="button" data-bs-toggle="collapse" data-bs-target="#detailReplace{{ $idx }}">
                                            <i class="bi bi-eye"></i> Rincian
                                        </button>
                                    </td>
                                </tr>
                                <tr class="collapse" id="detailReplace{{ $idx }}">
