                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item">
                            <a href="{{ route('members.home') }}" class='sidebar-link'>
                                <i class="bi bi-grid-fill"></i>
                                <span>Dashboard</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="{{ route('members.report.index') }}" class='sidebar-link'>
                                <i class="bi bi-easel"></i>
                                <span>Report</span>
                            </a>
                        </li>

                        <!-- Tambahkan menu lain jika perlu, atau sesuaikan dengan kebutuhan -->

                        <li class="sidebar-title">Navigation</li>
                        <li class="sidebar-item">
                            <a href="{{ route('members.scan.index') }}" class='sidebar-link'>
