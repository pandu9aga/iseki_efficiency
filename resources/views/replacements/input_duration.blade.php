...
<body>
    ...
    <div class="card">
        <h2 class="title">Input Durasi Pergantian</h2>
        <div class="subtitle">Berapa total menit pergantian kali ini?</div>
        ...
        <form method="POST" action="{{ route('replacements.storeDuration') }}">
            @csrf
