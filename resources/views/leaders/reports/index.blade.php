                            ...
                            <table class="table table-bordered table-sm" style="table-layout: fixed;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                                ...
                                                $jamMenit = \App\Helpers\Formatter::decimalToJamMenit($totalHours);
                                            @endphp
                                ...
                                <tfoot class="table-light">
                                    <tr>
                                        ...
                                        <th>
                                            @php $grandTotalJamMenitCostArea = \App\Helpers\Formatter::decimalToJamMenit($grandTotalCostArea); @endphp
                            ...
                            <table class="table table-bordered table-sm" style="table-layout: fixed;">
                                ...
                                <tfoot class="table-light">
                                    <tr>
                                        <th>Total Absensi</th>
                                        <th>
                                            @php $grandTotalJamMenitPowerArea = \App\Helpers\Formatter::decimalToJamMenit($grandTotalPowerArea); @endphp
                            ...
                            <table class="table table-bordered table-sm" style="table-layout: fixed;">
                                ...
                                <tfoot class="table-light">
                                    <tr>
                                        ...
                                        <th>
                                            @php $grandTotalJamMenitPenangananArea = \App\Helpers\Formatter::decimalToJamMenit($grandTotalPenangananArea); @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                                ...
                                                $jamMenitScanArea = \App\Helpers\Formatter::decimalToJamMenit($totalScanHoursArea);
                                            @endphp
